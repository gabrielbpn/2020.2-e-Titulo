...
<p style="text-indent: 20px; text-align: justify">
A participação do público foi essencial para a compreessão de como o aplicativo é utilizado e quando é utilizado, a partir das respostas, conseguimos elicitar requisitos, segue a seguir as perguntas que fizemos
</p>
...
- As respostas nos ajudam a identificar o comportamento do aplicatico em relação ao usuário?
- O questionário será distribuído para público alvo?

## Resultados
As respostas do questinário estão listadas abaixo
